...
<div class="container m-auto">
  <div class="bg-white border rounded-sm border-gray-300 m-5 p-3">
    <form method="POST" action="{{ route('tasks.store') }}">
      ...
      <div class="m-2">
        <button class="mt-2 py-1 px-2 border rounded border-transparent border-gray-300 text-gray-700 focus:outline-none focus:border-transparent bg-blue-200 hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:ring-opacity-50">
          作成
        </button>
      </div>
